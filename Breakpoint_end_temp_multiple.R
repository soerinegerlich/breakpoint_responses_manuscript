...
df_summary_temp_end$Plot[df_summary_temp_end$Plot == "Art2"] <- "Plot 2" 
df_summary_temp_end$Plot[df_summary_temp_end$Plot == "Art3"] <- "Plot 3" 
df_summary_temp_end$Plot[df_summary_temp_end$Plot == "Art4"] <- "Plot 4" 
df_summary_temp_end$Plot[df_summary_temp_end$Plot == "Art5"] <- "Plot 5" 
df_summary_temp_end$Plot[df_summary_temp_end$Plot == "Art6"] <- "Plot 6"
df_summary_temp_end$Plot[df_summary_temp_end$Plot == "Art7"] <- "Plot 7" 


df_summary_temp_end$SpeciesID[df_summary_temp_end$SpeciesID == "CHCE"] <- "Chironomidae"
