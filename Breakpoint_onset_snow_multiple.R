...
df_summary_all_onset <-
  subset(
    df_summary_all_onset,
    df_summary_all_onset$Plot != "Art1" |
      df_summary_all_onset$SpeciesID != "Collembola"
  )
df_summary_all_onset <-
  subset(
    df_summary_all_onset,
    df_summary_all_onset$Plot != "Art1" |
      df_summary_all_onset$SpeciesID != "Acari"
  )
...
df_summary_all_onset$Plot[df_summary_all_onset$Plot == "Art1"] <-
  "Plot 1"
df_summary_all_onset$Plot[df_summary_all_onset$Plot == "Art2"] <-
  "Plot 2"
df_summary_all_onset$Plot[df_summary_all_onset$Plot == "Art3"] <-
  "Plot 3"
df_summary_all_onset$Plot[df_summary_all_onset$Plot == "Art4"] <-
  "Plot 4"
df_summary_all_onset$Plot[df_summary_all_onset$Plot == "Art5"] <-
  "Plot 5"
df_summary_all_onset$Plot[df_summary_all_onset$Plot == "Art6"] <-
  "Plot 6"
df_summary_all_onset$Plot[df_summary_all_onset$Plot == "Art7"] <-
  "Plot 7"


df_summary_all_onset$SpeciesID[df_summary_all_onset$SpeciesID == "CHCE"] <-
  "Chironomidae"
df_summary_all_onset$SpeciesID[df_summary_all_onset$SpeciesID == "ANMU"] <-
  "Muscidae"
