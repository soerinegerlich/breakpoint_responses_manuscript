...
#require(writexl)
#write_xlsx(df_summary_all, "Data/Summary_tables\\df_summary_end_snow_temp_new.xlsx", col_names = TRUE)

######## Read summary excel file to do a bit of data clean up #########

df_summary_all_end <-
  read_xlsx("Data/Summary_tables/df_summary_end_snow_temp_new.xlsx")
...
df_summary_all_end <-
  df_summary_all_end[!(df_summary_all_end$Plot == "Art1" &
                         (df_summary_all_end$Order == "Decomposer")), ]
...
df_summary_all_end$Plot[df_summary_all_end$Plot == "Art1"] <-
  "Plot 1"
df_summary_all_end$Plot[df_summary_all_end$Plot == "Art2"] <-
  "Plot 2"
df_summary_all_end$Plot[df_summary_all_end$Plot == "Art3"] <-
  "Plot 3"
df_summary_all_end$Plot[df_summary_all_end$Plot == "Art4"] <-
  "Plot 4"
df_summary_all_end$Plot[df_summary_all_end$Plot == "Art5"] <-
  "Plot 5"
df_summary_all_end$Plot[df_summary_all_end$Plot == "Art6"] <-
  "Plot 6"
df_summary_all_end$Plot[df_summary_all_end$Plot == "Art7"] <-
  "Plot 7"


df_summary_all_end$SpeciesID[df_summary_all_end$SpeciesID == "CHCE"] <-
  "Chironomidae"
df_summary_all_end$SpeciesID[df_summary_all_end$SpeciesID == "ANMU"] <-
  "Muscidae"
df_summary_all_end$SpeciesID[df_summary_all_end$SpeciesID == "MYSC"] <-
  "Sciaridae"

write_xlsx(df_summary_all_end, "Data/Summary_tables\\df_summary_end_snow_temp_final_new.xlsx", col_names = TRUE)
