...
marginFig1<-unit(c(0.5,0.1,1,-4.5), "cm")
marginFig1Bottom<-unit(c(0.5,0.1,-0.5,-4.5), "cm")

marginFig2<-unit(c(0.5,0,1,0.1), "cm")
marginFig2Bottom<-unit(c(0.5,0,-0.5,0.1), "cm")

marginFig3<-unit(c(0.5,0.1,1,0), "cm")
marginFig3Bottom<-unit(c(0.5,0.1,-0.5,0), "cm")

marginFig4<-unit(c(0.5,0,1,0.1), "cm")
marginFig4Bottom<-unit(c(0.5,0,-0.5,0.1), "cm")
...
Plot12 <- ggplot(df_summary_temp_end, aes(y = SpeciesID, x = Slope1)) +
  ...
  theme(panel.grid = element_blank(),
        ...
        #plot.margin = marginFig1
        #plot.margin = unit(c(0.5,0.1,-0.5,-4.5), "cm")
        plot.margin = marginFig1Bottom
  )
...
snow <- ggarrange(
  ...
  theme(plot.margin = margin(2.5, 2.5, 3.5, 3, "cm"))
...
temp <- ggarrange(
  ...
  theme(plot.margin = margin(2.5, -0.5, 3.5, 6.5, "cm"))
