...
#require(writexl)
#write_xlsx(df_summary_all, "Data/Summary_tables\\df_summary_snow_temp_peak_50.xlsx", col_names = TRUE)
...
df_summary_all_peak <-
  read_xlsx("Data/Summary_tables/df_summary_peak_snow_temp.xlsx")
...
write_xlsx(df_summary_all_peak, "Data/Summary_tables\\df_summary_peak_snow_temp_final.xlsx", col_names = TRUE)
